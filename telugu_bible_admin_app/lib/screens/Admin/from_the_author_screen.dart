...
class AdminFromTheAuthorScreen extends StatefulWidget {
  static const String id = "admin-fromtheAuthor";

  const AdminFromTheAuthorScreen({Key? key}) : super(key: key);

  @override
  State<AdminFromTheAuthorScreen> createState() =>
      _AdminFromTheAuthorScreenState();
}

class _AdminFromTheAuthorScreenState extends State<AdminFromTheAuthorScreen> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text("From The Author", style: AppStyles.headlineText),
              ElevatedButton(
...
//===================  Delete Data =======================
  ...
  Future buildDeleteDataWidget(id) {
    return showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () {
              FirebaseDatabaseServices().deleteFromTheAuthorDataUsingID(id);
...
//================= Add data  ====================================
  ...
  Future buildAddDataFunction() {
    ...
    Future<void> submitData() async {
      FirebaseDatabaseServices().addFromTheAuthorData({
